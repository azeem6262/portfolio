      ...
      <nav className="fixed top-0 left-0 right-0 p-4 sm:p-6 flex items-center justify-between z-50 backdrop-blur-sm border-b border-border/50">
        ...
        <div className="flex items-center gap-2 sm:gap-4 text-base tracking-widest uppercase font-semibold text-muted-foreground overflow-hidden">
          <a href="#about" className="px-4 py-2 rounded-lg hover:bg-secondary/40 hover:text-foreground transition-all duration-300 flex items-center relative group">
            <span className="absolute left-2 opacity-0 group-hover:opacity-100 text-indigo-500 font-bold transition-all duration-300 -translate-x-2 group-hover:translate-x-0">{'>'}</span>
